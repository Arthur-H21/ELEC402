...
set DESIGN credit_card_payment_fsm
...
##A CHANGE HERE IS REQUIRED##
#read_hdl ./in/credit_card_payment_fsm.sv
##System Verilog
read_hdl -sv ./in/credit_card_payment_fsm.sv
...
##A CHANGE HERE IS REQUIRED##
read_sdc ./in/credit_card_payment_fsm.sdc
######################################################################
...
write_hdl -mapped > ./files_out/${DESIGN}_map.sv
